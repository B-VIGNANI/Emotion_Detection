...
BACKGROUND_IMAGE = "https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExNWVmaG12amhhbmR1OWZoNGdmN3h1MDMwZW5sYmZzOW81ZGp6dWJkcCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/elcAvTEXkG02d17sr7/giphy.gif"
# Configure Gemini API
try:
    genai.configure(api_key="AIzaSyAu4UFuQu9tssMn7WwuH2ro4ywcdOUtJ0k")
...
with st.sidebar:
    ...
    st.markdown(
        ...
        [data-testid="stSidebar"] {
            background-image: url("https://github.com/ADHIL48/Emotion_Recognition_app/raw/main/Tinkter_app/background_menu.png");
            background-size: cover;
            background-position: center;
            background-repeat: no-repeat;
        }
    ...
    logo_url = "https://github.com/ADHIL48/Emotion_Recognition_app/raw/main/Tinkter_app/logo.png"
...
if app_mode == "Home":
    ...
    st.title("💬 AI Emotional Support Chat")
    st.write("Chat with our AI assistant for emotional support and guidance")
    
    # Initialize chat history
    if "messages" not in st.session_state:
        st.session_state.messages = [{"role": "assistant", "content": "Hi! I'm your emotional support assistant. How can I help you today?"}]
